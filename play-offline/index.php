...
<head>
  ...
  <title>Play Offline | Azox Network</title>
  <link rel="stylesheet" href="../style.css">
  <meta name="description" content="Bypass online verification and play on the azox network with any launcher on almost any version without paying a cent.">
...
<body>
  ...
  <main class="container">
    <div class="hero-section">
      ...
      <h1>Offline Guide</h1>
      <p>Step-by-step instructions to connect to the Azox Network without a paid account and begin your Trial by Fate.</p>
    </div>
